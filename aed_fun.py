# FUNCIONES PARA GENERAR TABLAS DE FRECUENCIAS CON VARIABLES NOMINALES
...
# Función sin orden predefinido de las categorias
...
# Función con orden predefinido de las categorias
